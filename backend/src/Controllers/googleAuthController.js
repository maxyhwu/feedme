...
const googleOauthHandler = async (req,res,next) => {
    ...
    res.cookie('user', {userName: user.userName, email: user.email, token: token, fridge: user.fridge, like: user.like, favorite: user.favorite, notiRec: user.notiRec, notiIngre: user.notiIngre, image: user.image, provider: user.provider});
